...
impl CPU {
    ...
    pub fn handle_op(&mut self, opcode: u8) -> u8 {
        match opcode {
            ...
            // ADD HL, BC
            0x09 => {
                let bc = self.registers.read_sixteen(SixteenBitRegister::BC);
                // TODO: this should set flags
                self.registers
                    .update_sixteen(SixteenBitRegister::HL, |hl| hl.wrapping_add(bc));
            ...
            // ADD HL, DE
            0x19 => {
                let de = self.registers.read_sixteen(SixteenBitRegister::DE);

                self.registers
                    .update_sixteen(SixteenBitRegister::HL, |hl| hl.wrapping_add(de));
            ...
            // ADD HL, HL
            0x29 => {
                let hl = self.registers.read_sixteen(SixteenBitRegister::HL);

                self.registers
                    .update_sixteen(SixteenBitRegister::HL, |hl| hl.wrapping_add(hl));
            ...
            0x39 => {
                ...
                self.registers
                    .update_sixteen(SixteenBitRegister::HL, |hl| hl.wrapping_add(sp));
