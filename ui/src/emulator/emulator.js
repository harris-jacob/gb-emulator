...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_get_reg')) {
        Object.defineProperty(Module['ready'], '_get_reg', { configurable: true, get: function() { abort('You are getting _get_reg on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_get_reg', { configurable: true, set: function() { abort('You are setting _get_reg on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_step')) {
        Object.defineProperty(Module['ready'], '_step', { configurable: true, get: function() { abort('You are getting _step on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_step', { configurable: true, set: function() { abort('You are setting _step on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'bin/emulator.data';
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_bin/emulator.data');

      };
      Module['addRunDependency']('datafile_bin/emulator.data');
...
/** @type {function(...*):?} */
var _get_reg = Module["_get_reg"] = createExportWrapper("get_reg");
