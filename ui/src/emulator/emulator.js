...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_peek_reg')) {
        Object.defineProperty(Module['ready'], '_peek_reg', { configurable: true, get: function() { abort('You are getting _peek_reg on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_peek_reg', { configurable: true, set: function() { abort('You are setting _peek_reg on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
